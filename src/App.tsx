...
function App() {
    ...
    useEffect(() => {
        if (isAuthenticated && account) {
            ...
            setUserEmail(account.username || "UNKNOWN EMAIL");
        }
    }, []);
    ...
    useEffect(() => {
        async function fetchProfilePicture() {
            ...
            const photoUrl = await userService.getUserPhoto(
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (response.account) {
                ...
                setUserEmail(response.account.username || "UNKNOWN EMAIL");
    ...
    return (
        <>
            ...
            {isLoggedIn && <p>Email: {userEmail}</p>}
            <div className="card">
                {!isLoggedIn && (
                ...
                {isLoggedIn && (
                    <div className="button-div">
                        <button
                            className="feature-button"
                            onClick={handleQuerySemanticModel}
                        >
                            Query Fabric Semantic Model
                        </button>
                    </div>
                )}
                {isLoggedIn && (
